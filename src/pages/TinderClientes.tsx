...
import { 
    ...
    Info, Star, Navigation, Map as MapIcon, CheckCircle2, RotateCcw
} from 'lucide-react';
import { useTinderClientes, TinderClient } from '../hooks/useTinderClientes';

interface SwipeCardProps {
    client: TinderClient;
    onSwipe: (direction: 'left' | 'right', client: TinderClient) => void;
    index: number;
}

// --- Card Component ---
const SwipeCard = ({ client, onSwipe, index }: SwipeCardProps) => {
