        ...
        queryFn: async () => {
            ...
            if (hasTextFilter) {
                const { data: rpcData, error: rpcError } = await supabase.rpc('buscar_clientes_empresa', {
                    ...
                    p_estados: fEstado && fEstado.length > 0 ? fEstado : undefined,
                    p_situaciones: fSituacion && fSituacion.length > 0 ? fSituacion : undefined,
                    p_tipos_contacto: fTipoContacto && fTipoContacto.length > 0 ? fTipoContacto : undefined,
                    p_responsables: fResponsable && fResponsable.length > 0 ? fResponsable : undefined,
                    p_creados_por: fCreadoPor && fCreadoPor.length > 0 ? fCreadoPor : undefined,
                    p_rubros: fRubro && fRubro.length > 0 ? fRubro : undefined,
                    p_intereses: fInteres && fInteres.length > 0 ? fInteres : undefined,
                    p_estilos: fEstilo && fEstilo.length > 0 ? fEstilo : undefined,
                    ...
                    p_grupos: fGrupos && fGrupos.length > 0 ? fGrupos.map(Number) : undefined,
                    p_missing_coords: fMissingCoords || undefined,
                    p_missing_contact: fMissingContact || undefined,
                    p_missing_rubro: fMissingRubro || undefined,
