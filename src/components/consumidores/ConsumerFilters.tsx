...
interface ConsumerFiltersProps {
    fNombre: string;
    setFNombre: (val: string) => void;
    fTelefono: string;
    setFTelefono: (val: string) => void;
    fLocalidad: string;
    setFLocalidad: (val: string) => void;
    fEstado: string;
    setFEstado: (val: string) => void;
    fResponsable: string;
    setFResponsable: (val: string) => void;
    setPage: (page: number | ((prev: number) => number)) => void;
}

export const ConsumerFilters = ({
    fNombre, setFNombre,
    fTelefono, setFTelefono,
    fLocalidad, setFLocalidad,
    fEstado, setFEstado,
        ...
        <section style={{
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '16px', alignItems: 'center' }}>
                <div style={{ flex: 1, minWidth: '260px', position: 'relative' }}>
                    ...
                    <input 
                        className="input" 
                        placeholder={t('consumers.filters.search_placeholder') as string} 
                        value={fNombre} 
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '20px' }}>
                        <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', gap: '4px' }}>
                            ...
                            <div style={{ position: 'relative' }}>
                                ...
                                <input className="input" placeholder={t('consumers.filters.phone') as string} value={fTelefono} onChange={e => { setFTelefono(e.target.value); setPage(1); }} style={{ width: '100%', paddingLeft: '40px', borderRadius: '12px' }} />
                            </div>
                        </div>
                        ...
                        <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', gap: '4px' }}>
                            ...
                            <div style={{ position: 'relative' }}>
                                ...
                                <input className="input" placeholder={t('consumers.filters.location') as string} value={fLocalidad} onChange={e => { setFLocalidad(e.target.value); setPage(1); }} style={{ width: '100%', paddingLeft: '40px', borderRadius: '12px' }} />
                            </div>
                        </div>
