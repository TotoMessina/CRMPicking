...
interface MasivoModalProps {
    isOpen: boolean;
    onClose: () => void;
    usersCache: any[];
    initialUsuario?: string | null;
    onSaved: () => void;
    empresaActiva?: any;
}

export function MasivoModal({ 
    isOpen, 
    onClose, 
    usersCache, 
    initialUsuario, 
    ...
    const checkCollision = (start: Date, end: Date, list: any[]) => {
        return list.some(t => {
        ...
        <div className="modal is-open" onClick={onClose}>
            <div className="modal-content modal-sm" onClick={e => e.stopPropagation()}>
                <div className="modal-header">
                    <h3>⚡ Carga Masiva de Horarios</h3>
