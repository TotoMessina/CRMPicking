...
import { LogOut, Sun, Moon, Bell, Building2, ChevronDown, Navigation, Bot, LucideIcon } from 'lucide-react';
...
const SidebarBrand = ({ setIsMobileMenuOpen, empresaActiva }: SidebarBrandProps) => {
    ...
    <div className="sidebar-brand">
        {logoUrl ? (
            ...
            <div className="sidebar-brand-logo">
                <div className="sidebar-logo sidebar-fallback-logo">
...
const UserInfo = ({ userName, email, avatarUrl, empresaActiva, empresasDisponibles, onChangeEmpresa }: UserInfoProps) => {
    const { t } = useTranslation();
    return (
...
const NavItem = ({ item, unreadChatCount, setIsMobileMenuOpen }: NavItemProps) => {
    const { t } = useTranslation();
    ...
    return (
        <li onClick={() => setIsMobileMenuOpen(false)}>
            ...
            >
                ...
                <span className="sidebar-nav-label">{t(labelKey, { defaultValue: item.label })}</span>
...
const NavGroup = ({ groupName, items, unreadChatCount, setIsMobileMenuOpen, isOpen, onToggle }: NavGroupProps) => {
    const { t } = useTranslation();
...
function getActiveGroup(pathname: string, navItems: any[], defaultGroup = 'Activaciones'): string {
        ...
        <div className="app-shell">
            ...
            <aside className={`sidebar ${isMobileMenuOpen ? 'open' : ''}`}>
                ...
                <div className="sidebar-footer">
                    ...
                    <button
                        className="sidebar-ruta-btn sidebar-ai-btn"
                        onClick={() => {
                    ...
                    >
                        <Bot size={14} />
                        <span>{t(tenantConfig.ai.name || '')}</span>
                    </button>
